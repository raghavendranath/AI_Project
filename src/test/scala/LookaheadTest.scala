...
class LookaheadTest extends FunSpec{
  registerTest("Simple lookahead search") {
    ...
    val path = Lookahead.search(grid, 3)
    val expectedPath = List(new Point(0.0,0.0), new Point(4.0,6.0), new Point(4.0,8.0), new Point(10.0,10.0))
  ...
  registerTest("Moderate lookahead search (Backtracking)") {
    ...
    val path = Lookahead.search(grid, 3)
    val expectedPath = List(new Point(0.0,0.0), new Point(15.0,10.0), new Point(12.0,12.0), new Point(11.0,15.0), new Point(15.0,18.0), new Point(20.0,20.0))
    assert(path == expectedPath)
  }
  ...
  registerTest("Moderate lookahead search 2") {
    ...
    val expectedPath = List(new Point(0.0,0.0), new Point(10.0,0.0), new Point(14.0,4.0), new Point(20.0,20.0))
    assert(path == expectedPath)
  }
  ...
  registerTest("Difficult lookahead search") {
    ...
    val path = Lookahead.search(grid, 2)
  ...
  registerTest("Difficult lookahead search 3") {
    ...
    val path = Lookahead.search(grid, 3)
    val expectedPath = List(new Point(0.0,0.0), new Point(6.0,6.0), new Point(4.0,9.0), new Point(1.0,11.0), new Point(8.0,17.0), new Point(20.0,20.0))
    assert(path == expectedPath)
  }
  ...
  registerTest("Difficult lookahead search 4") {
    ...
    val path = Lookahead.search(grid, 3)
    val expectedPath = List(new Point(8.0,2.0), new Point(10.0,0.0), new Point(18.0,0.0), new Point(20.0,0.0), new Point(20.0,20.0))
    assert(path == expectedPath)
  }
  ...
  registerTest("Large lookahead search 3") {
    ...
    val path = Lookahead.search(grid, 3)
    val expectedPath = List(new Point(5.0,95.0), new Point(0.0,93.0), new Point(0.0,54.0), new Point(3.0,45.0), new Point(2.0,38.0), new Point(23.0,34.0), new Point(30.0,50.0))
    assert(path == expectedPath)
  }
